...
const Home = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#121212] p-4 sm:p-5">
      <div className="border border-gray-200 dark:border-[#F5F5F5] max-w-screen-lg mx-auto text-gray-900 dark:text-white rounded-3xl px-4 sm:px-8 md:px-16 pt-6">
        <Layout>
          {/* Hero Section */}
          <div className="mt-10 sm:mt-20 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex space-x-2 justify-between items-center w-full sm:w-auto">
              ...
              <button
                ...
                className="bg-[#f5f5f5] w-10 h-10 rounded-3xl text-black flex justify-center items-center"
              >
                <svg
          ...
          <div className="mt-8 sm:mt-10 flex flex-col-reverse sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-15">
            <p className="text-md font-normal text-[#808080] w-full sm:w-80">
              My goal is to{" "}
              <span className="italic text-black dark:text-[#f5f5f5]">
          ...
          <div className="mt-8 sm:mt-12 flex overflow-x-auto pb-4 gap-2 sm:justify-between sm:max-w-screen-md sm:mx-auto">
            <Link
              ...
              target="_blank"
              className="border border-gray-200 dark:border-[#F5F5F5]  rounded-3xl p-2 min-w-32 flex justify-center items-center gap-2 text-[#808080] italic"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
                className="bi bi-github text-black dark:text-white"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-linkedin text-black dark:text-white"
                viewBox="0 0 16 16"
              >
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-whatsapp text-black dark:text-white"
                viewBox="0 0 16 16"
              >
            ...
            <Link
              href="https://www.facebook.com/share/1ATSjQBBin/"
              target="_blank"
              className="border border-gray-200 dark:border-[#F5F5F5]  rounded-3xl p-2 min-w-32 flex justify-center items-center gap-2 text-[#808080] italic"
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-facebook text-black dark:text-white"
                viewBox="0 0 16 16"
              >
            ...
            <button className="border border-gray-200 dark:border-[#F5F5F5]  rounded-3xl p-2 min-w-32 flex justify-center items-center gap-2 text-[#808080] italic">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
                className="bi bi-instagram text-black dark:text-white"
                viewBox="0 0 16 16"
              >
          ...
          <div className="-mx-4 sm:-mx-16 mt-10 sm:mt-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-4 px-4 sm:px-16 py-4">
              ...
              <Link href="https://webable.digital/" target="_blank">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-4 px-4 sm:px-16 py-4 bg-[#F5F5F5] text-black">
              ...
              <Link href="https://reserveitbd.com/" target="_blank">
                {" "}
